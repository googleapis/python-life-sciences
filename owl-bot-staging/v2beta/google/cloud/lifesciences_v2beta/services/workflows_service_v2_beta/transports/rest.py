...
from .base import WorkflowsServiceV2BetaTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class WorkflowsServiceV2BetaRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_run_pipeline(self, request: workflows.RunPipelineRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[workflows.RunPipelineRequest, Sequence[Tuple[str, str]]]:
