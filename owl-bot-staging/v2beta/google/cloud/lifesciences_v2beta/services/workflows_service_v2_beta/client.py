...
class WorkflowsServiceV2BetaClientMeta(type):
    """Metaclass for the WorkflowsServiceV2Beta client.

    This provides class-level methods for building and retrieving
    support objects (e.g. transport) without polluting the client instance
    objects.
    """
    _transport_registry = OrderedDict()  # type: Dict[str, Type[WorkflowsServiceV2BetaTransport]]
...
class WorkflowsServiceV2BetaClient(metaclass=WorkflowsServiceV2BetaClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            WorkflowsServiceV2BetaClient: The constructed client.
        """
    ...
    def transport(self) -> WorkflowsServiceV2BetaTransport:
        ...
        Returns:
            WorkflowsServiceV2BetaTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, WorkflowsServiceV2BetaTransport]] = None,
    ...
    def run_pipeline(self,
        ...
        **Note:** Before you can use this method, the *Life Sciences
        ...
        # in a workflows.RunPipelineRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, workflows.RunPipelineRequest):
